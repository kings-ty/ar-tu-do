...
def generate_launch_description():
    ...
    wall_follower_type = LaunchConfiguration('wall_follower_type', default='stable')
    ...
    declare_wall_follower_type_cmd = DeclareLaunchArgument(
        'wall_follower_type',
        default_value='stable',
        description='Wall follower type: stable or advanced'
    )
    ...
    # 안정적인 Wall Follower (기본값)
    stable_wall_follower_node = Node(
        package='circuit_learning',
        executable='stable_wall_follower.py',
        name='stable_wall_follower',
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        declare_wall_follower_type_cmd,
